...
<head>
  <meta charset="utf-8" />
  <link rel="icon" type="image/png" href="<?= base_url('assets/table/')?>assets/img/favicon.ico">
  ...
  <link href="<?= base_url('assets/table/')?>assets/css/fresh-bootstrap-table.css" rel="stylesheet" />
  <link href="<?= base_url('assets/table/')?>assets/css/demo.css" rel="stylesheet" />
  ...
  <script src="<?= base_url('assets/table/')?>assets/js/demo/gsdk-switch.js"></script>
  <script src="<?= base_url('assets/table/')?>assets/js/demo/jquery.sharrre.js"></script>
  <script src="<?= base_url('assets/table/')?>assets/js/demo/demo.js"></script>

  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.18.3/extensions/fixed-columns/bootstrap-table-fixed-columns.min.js"></script>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.18.3/extensions/export/bootstrap-table-export.min.css">
...
<div class="wrapper">
  ...
  <a href="#">
    <div class="logo-container full-screen-table-demo">
        <!--
      <div class="logo">
      <img src="<?= base_url('assets/table/')?>assets/img/new_logo.png">
      </div>
-->
      <div class="brand">
        Outstanding Order
  ...
  -->
    ...
    echo "<th style='text-align:center;'>TOTAL BJ</th>";
    ?>
    </tr>
    </thead>
      <tbody>
    ...
    <ul class="dropdown-menu">
      ...
      <li>
          <a class="img-holder" href="compact-table.html">
            <img src="<?= base_url('assets/table/')?>assets/img/compact.jpg">
            <h5>Compact Table</h5>
          </a>
        </li>
        <li class="active">
          <a class="img-holder" href="full-screen-table.html">
            <img src="<?= base_url('assets/table/')?>assets/img/full.jpg">
