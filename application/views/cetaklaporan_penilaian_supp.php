...
<table width="100%" border="1" rules="all">
    <thead>
        <tr>
        <th rowspan="4" colspan="2"><img src="<?= base_url('assets\img\bk.png')?>" style="width:70px;height:50px;"></th>
        <th rowspan="4" colspan="4">PT. BEAUTY KASATAMA INDONESIA<br>EVALUASI KINERJA SUPPLIER<br>Periode : <?= $mulai;?>&nbsp;s/d&nbsp;<?= $hingga;?></th>
        </tr>
        <tr>
