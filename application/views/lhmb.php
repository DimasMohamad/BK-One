...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>LAPORAN HARIAN MASUK BARANG</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item">Warehouse</li>
                <li class="breadcrumb-item active">Laporan Harian Barang Masuk (GRPO)</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
...
<script type="text/javascript">
    ...
    function tampil(){
        ...
        $.get("<?= base_url('Whse/tb_lhmb?mulai=') ?>"+mulai+"&hingga="+hingga+"&grup="+item+"&cari="+cari+"&sts="+sts, function(data, status) {
