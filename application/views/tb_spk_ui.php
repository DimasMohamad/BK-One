...
<meta charset="UTF-8">
	...
	<table id="dg" class="easyui-datagrid" title="SPK LIST" style="width:100%;height:100%"
			data-options="singleSelect:true,toolbar:'#tb',collapsible:false,url:'',method:'get'">
		...
		<thead>
			<tr>
                ...
                <th data-options="field:'spk'">No SPK</th>
    ...
    <div id="w" class="easyui-window" title="SPK Routing" data-options="modal:true,closed:true,maximizable:false,minimizable:false,collapsible:false" style="width:95%;height:95%;padding:10px;">
        ...
        <div class="easyui-panel" style="padding:5px;">
            <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-save'" onclick="cetakspk()">Download</a>
        ...
        $('#dg').datagrid({
                    ...
                    onExpandRow: function(index,row){
                        ...
                        ddv.datagrid({
                            ...
                            height:'auto',
                            columns:[[
                                {field:'spk',title:'No SPK Child'},
                                {field:'created_date',title:'Created date'},
                                {field:'item_no',title:'Item Code'},
                                {field:'DESCRIPTION',title:'Item Name'},
                                {field:'qty_order',title:'Qty Order',align:'right',formatter: formatNumber},
                                {field:'qty_buffer',title:'Qty Buffer',align:'right',formatter: formatNumber},
                                {field:'qty_prod',title:'Qty Prod',align:'right',formatter: formatNumber},
                                {field:'mesin',title:'Mesin'},
