...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>LAPORAN HARIAN MASUK BARANG (P)</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item">Warehouse</li>
                <li class="breadcrumb-item active">Laporan Harian Barang Masuk (P)</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                ...
                                <input type="text" id="cari" class="form-control" placeholder="No BPB / No. SJ / Item Code / Item / Comments / Free text /">
                            </div>
                            <div class="col-xl-12">
                            <label class="small mb-1">Group</label>
                                <select class="form-control" id="item" name="item[]" multiple="multiple">
                                    <?php
                                    foreach ($row['grup'] as $g) {
                                        echo "<option value=" . $g['ItmsGrpCod'] . ">" . $g['ItmsGrpNam'] . "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
...
<script type="text/javascript">
    ...
    function tampil(){
        ...
        $.get("<?= base_url('Whse/tb_lhmbp?mulai=') ?>"+mulai+"&hingga="+hingga+"&grup="+item+"&cari="+cari+"&sts="+sts, function(data, status) {
    ...
    function unduh(){
        ...
        let cari = $("#cari").val();
        let sts = $("#sts").val();
        window.open("<?= base_url('Whse/tb_lhmbp_xls?mulai=') ?>"+mulai+"&hingga="+hingga+"&grup="+item+"&sts="+sts,"_self");
    }
    ...
    function cetak(){
        ...
        let cari = $("#cari").val();
        let sts = $("#sts").val();
        window.open("<?= base_url('Whse/tb_lhmbp_cetak?mulai=') ?>"+mulai+"&hingga="+hingga+"&grup="+item+"&sts="+sts);
    }
