...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>Legalitas Beauty Kasatama Indonesia</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                <li class="breadcrumb-item">Legal</li>
                <li class="breadcrumb-item active">Legalitas BKI</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Upload Dokumen Legalitas</h5>
...
<script>
    function tampildata() {
        ...
        $.get("<?= base_url('Legal/tampil_data') ?>", function(data, status) {
