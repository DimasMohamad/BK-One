...
class M_bp extends CI_Model
{
    ...
    public function bp_head()
    {
        ...
        left join "' . $this->database_name . '"."OCRY" B on B."Code" = A."Country"
        Left join(select "DocEntry","CardCode" from "' . $this->database_name . '"."OPOR")C on C."CardCode" = A."CardCode"
    ...
    public function bp_detail()
    {
        ...
        Left join(select A."DocEntry",A."ItemCode",C."ItmsGrpNam"
                  ...
                  Left Join "' . $this->database_name . '"."OITM" B on B."ItemCode" = A."ItemCode"
                  Left Join "' . $this->database_name . '"."OITB" C on C."ItmsGrpCod" = B."ItmsGrpCod"
    ...
    public function bp_terpilih($mulai, $hingga)
    {
        ...
        left join (
            ...
            FROM "' . $this->database_name . '"."OPOR") C ON C."CardCode" = A."CardCode"
        left join (
	        select "Address", "CardCode" 
	        from "' . $this->database_name . '"."OCPR") D ON D."CardCode" = A."CardCode" 
    ...
    public function bp_detail_terpilih()
    {
        ...
        left join (select "DocEntry", "ItemCode" from "' . $this->database_name . '"."POR1") B on B."DocEntry" = A."DocEntry"
